...
const [selectedLanguage, setSelectedLanguage] = useState('Language');
  ...
  const filteredDoctors = doctors.nodes.filter(doctor => {
    return (
      ...
      (selectedLocation === 'Location' || doctor.doctorFields.location === selectedLocation) &&
      (selectedLanguage === 'Language' || (typeof doctor.doctorFields.languages === 'string' && doctor.doctorFields.languages.includes(selectedLanguage)))
    );
  });
...
<div className="dr_page_selection_container dr_page_container" style={{paddingRight: "10px", display: "flex", justifyContent: "center"}}>
          <div className="dr_page_selection_wrap">
            ...
            <div className="dr_page_selection_block">
              <select className="dr_selectcontrol" id="specializationSelect" onChange={handleSpecialtyChange}>
            ...
            <div className="dr_page_selection_block">
              <select className="dr_selectcontrol" id="languageSelect" onChange={handleLanguageChange}>
    ...
    <DoctorsTile allPosts={doctors} filterddoctors={filteredDoctors} />
      </>
  );
};
