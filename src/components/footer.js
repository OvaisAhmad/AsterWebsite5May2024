  ...
  return (
    <>
      ...
      >
        ...
        >
          <div style={{ boxSizing: 'border-box', marginBottom: '55px' }}>
            <Image
              alt='Image'
              src='/medcare.jpg'
              width={311}
                      ...
                      >
                        ...
                        >
                          <div className='flex flex-row items-start justify-start gap-[25px]'>
                            ...
                            />
                            <div className='footer_tile self-stretch relative capitalize inline-block w-[180px] shrink-0'>
                              {news?.title}
                            </div>
                          </div>
                        </Link>
          ...
          <div className='footer_conatiner_md'>
            <details style={{ fontSize: 16, marginBottom: 10 }}>
              <summary>{t('footer.Patient Services')}</summary>
              <ul
                style={{
                  boxSizing: 'border-box',
                  listStyle: 'none',
              ...
              >
                ...
                <li style={{ boxSizing: 'border-box', marginTop: '8px' }}>
                  <Link
                    href='/appointment'
                    style={{
                      boxSizing: 'border-box',
            ...
            <details style={{ fontSize: 16, marginBottom: 10 }}>
              <summary>{t('footer.Specialisations')}</summary>
              <div
                style={{
                  boxSizing: 'border-box',
                  listStyle: 'none',
            ...
            <details style={{ fontSize: 16, marginBottom: 10 }}>
              <summary>{t('footer.Facilities & Services')}</summary>
              <div
                style={{
                  boxSizing: 'border-box',
                  listStyle: 'none',
            ...
            <details style={{ fontSize: 16, marginBottom: 10 }}>
              <summary>{t('footer.Aster Media Centre')}</summary>
              <ul
                style={{
                  boxSizing: 'border-box',
                  listStyle: 'none',
            ...
            <div>
              ...
              <p>
                Your personalised healthcare assistant for all your healthcare
                needs
              </p>
