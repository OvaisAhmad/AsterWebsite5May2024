        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Image
                  ...
                  width={100}
                  height={100}
                  src="https://www.aster.om/home-care"
                  style={{
                    boxSizing: "border-box",
                    borderStyle: "none",
              ...
              >
                {t("homecare.Preventive Health")}
                <br style={{ boxSizing: "border-box" }} /> {t("homecare.Check Packages")}
              </p>
              <i
            ...
            >
              ...
              >
                {t("homecare.Immunisations")}
                <br style={{ boxSizing: "border-box" }} /> {t("homecare.& Vaccinations")}
              </p>
              <i
                className="icon : icon-arrow-right"
                style={{
            ...
            >
              ...
              >
                {t("homecare.Aster Maternity")}
                <br style={{ boxSizing: "border-box" }} /> {t("homecare.Packages")}
              </p>
              <i
                className="icon : icon-arrow-right"
                style={{
