...
import { getAllSpecialization,getLastBlogs,getAllLocations,getAllFecilities, getLastNews } from "../../../lib/posts";
...
export default function About({blogData,dummyData,locations,facilities,lastNewses}) {
  ...
  return (
    <div className='flex flex-col'>
      ...
      <HeadBar/>
      <Description/>
      <LocationHeader locations={locations} specializations={dummyData}/>
      <BodyPage/>
      <Insurance/>
