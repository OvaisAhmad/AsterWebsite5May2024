...
export async function getStaticProps({ params, locale }) {
  console.log('checking param in specialities page', params.postSlug);
  console.log(
    'checking param in specialities page type',
    typeof params.postSlug
  );
...
export default function Post({
  ...
  const filteredDoctors = dummyData2.nodes?.filter((doctor) => {
    return (
      ...
      doctor.doctorFields.specializationAr === postData.title
    );
  });
