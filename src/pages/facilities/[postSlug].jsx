...
export async function getStaticProps({ params, locale }) {
  console.log('checking param in facilities page', params.postSlug);
  console.log('checking param in facilities page type', typeof params.postSlug);
...
export async function getStaticPaths({ locales }) {
  ...
  console.log('response form getStaticPaths', response);
